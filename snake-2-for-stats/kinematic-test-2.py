        ...
        for model in self.MODELS:
            ...
            for method in self.METHODS:
                ...
                for i in range(self.NPOINTS):
                    ...
                    # save result
                    df.loc[len(df)] = [ model, method, main_point, inferred_main_point, main_point_error, middle_point, middle_point_error, (end-start) ]
                    print(".", end="", flush=True)
        print()

    def write_to_files(self):
        self.df.to_csv("dataframe_output/df_latest_nomiddlepoints.csv")
